      ...
      *   Modified by: R.CH.  23/Ago/2020                              *
      *================================================================*
000100 IDENTIFICATION DIVISION.
000200 PROGRAM-ID.   TABLES02.
003200*
000300* ************************************************************
...
011400 200-PROCESS-RECORDS.
      *    MOVE STUDENT-RECORD TO WS-STUDENT-TABLE(STUDENT-SUB).
           PERFORM VARYING COURSES-SUB FROM 1 BY 1
              ...
              END-EVALUATE
           END-PERFORM.
           MOVE WS-STUDENT-TABLE(STUDENT-SUB) TO REPORT-LINE-OUT
